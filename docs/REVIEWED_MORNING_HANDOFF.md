...
4. The daily morning bake consumes the selected set for writing, Scripture
   pairing, rendering, and its final accuracy pass. It does not search for more
   candidates.
...
The packet fails closed when missing, stale, invalid, late, or incomplete.
Backfills keep their date-bounded historical research procedure because no
same-day reviewed packet can honestly be reconstructed after the fact.
